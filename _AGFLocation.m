...
// Make changes to AGFLocation.m instead.

#import "_AGFLocation.h"

const struct AGFLocationAttributes AGFLocationAttributes = {
	.address = @"address",
	.latitude = @"latitude",
	.longitude = @"longitude",
};

const struct AGFLocationRelationships AGFLocationRelationships = {
	.annotations = @"annotations",
	.snap = @"snap",
};

@implementation AGFLocationID
@end

@implementation _AGFLocation
...
- (AGFLocationID*)objectID {
	return (AGFLocationID*)[super objectID];
}
